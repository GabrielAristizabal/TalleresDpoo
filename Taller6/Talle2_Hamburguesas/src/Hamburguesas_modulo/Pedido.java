...
public class Pedido {
	...
	public void agregarProducto(Producto nuevoItem) throws HambueguesaExeption{
			if (verificarLimite()==false) {
	...
	private String generarTextoFactura() {
		...
		String texto = this.nombreCliente+";"+this.direccionCliente+";"+this.idPedido+";"+this.numeroPedido+";"+lista+";"+precion+";"+precioi+";"+preciot+";"+calorias;
		return texto;
	}
	...
	private boolean verificarLimite() {
		if (this.getPrecioTotalPedido()<150000)
			return false;
		else {
			return true;
		}
