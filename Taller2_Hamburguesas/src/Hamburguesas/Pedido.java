...
public class Pedido {
	...
	public String generarTextoFactura() {
		...
		String texto = this.nombreCliente+";"+this.direccionCliente+";"+this.idPedido+";"+this.numeroPedido+";"+lista+";"+precion+";"+precioi+";"+preciot;
		return texto;
	}
	
	public void generarFactura(File archivo) throws IOException {
		String explicacion = "Nombre;Direccion;ID,Numero de pedido;Productos;Precio Total; IVA(19%);Precio total"+"\n";
