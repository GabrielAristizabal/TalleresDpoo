...
public class Aplicacion {
	...
	public Aplicacion(String ingr, String menu, String comb) throws IOException {
		this.restaurante = new Restaurante();
		this.restaurante.cargarInformacionRestaurante(ingr, menu, comb);
	}
	...
	private void cerrarPedidoyyFacturar() throws IOException {
		this.restaurante.cerraryGuardadPedido();		
	}
	
	private void consultarInformacionID(){
	...
	public static void main(String[] args) throws IOException
	{
		...
		Aplicacion consola = new Aplicacion(ingr, menu, comb);
